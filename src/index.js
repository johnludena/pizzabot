...
console.log(`Hello, I'm version 2021`);
...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      botMessages: [],
      botGreeting:
        'Hi, my name is PizzaBot! I can help you get pizza. Try typing something like "I want a pepperoni pizza." below.',
      botLoading: false,
    };
  }
...
class BotBubble extends React.Component {
  ...
  render() {
    let svgLoader = (
      <img className="loader" src={chatLoader} alt="loading icon" />
    );
      ...
      <div className="bot-message-container">
        ...
        <div>
          <div className="chat-bubble bot" ref="chatBubble">
            {this.props.message ? this.props.message : svgLoader}
          </div>
          <TimeStamp />
        </div>
      </div>
...
class TimeStamp extends React.Component {
  ...
  render() {
    return <div className="time-stamp">{this.getTimeStamp()}</div>;
  }
}
